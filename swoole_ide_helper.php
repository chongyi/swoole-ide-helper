...
namespace {
    ...
    class swoole_server
    {
         ...
         *  * task进程ID范围是[$serv->setting['worker_num'], $serv->setting['worker_num'] +
         *  $serv->setting['task_worker_num'])
         *
         ...
         * 对于Server的配置即$serv->set()中传入的参数设置，必须关闭/重启整个Server才可以重新加载 Server可以监听一个内网端口，然后可以接收远程的控制命令，去重启所有worker
         *
         * @return bool
         */
